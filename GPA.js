...
var test1 = function() {
	console.log('Enter your math grade1 : ')
	let stdin = process.openStdin()
	stdin.addListener("data",(value) => {
		if (i === 1){
			s1 = value
			math = checkGpa(s1.toString().trim());
			console.log('Enter your physics grade2 :')}
		else if (i === 2){
			s2 = value
			phy = checkGpa(s2.toString().trim())
			console.log('Enter your biology grade3 :')}
		else if (i === 3){
			s3 = value
			bio = checkGpa(s3.toString().trim())
			console.log('Enter your chemistry grade4 :')}
		else if (i === 4){
			s4 = value
			chem = checkGpa(s4.toString().trim())
			console.log('Enter your english grade5 :')}
		else {
			s5 = value
